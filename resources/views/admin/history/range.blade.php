                ...
                @if (session('status'))
                    ...
                    <table class="table table-sm table-light table-hover">
                        ...
                        <tbody>
                          ...
                          @endif
                        </td><td><div class="btn-group-vertical btn-block"><a class="btn btn-secondary btn-sm @if($h->status == "DELETED" || $h->status == "ACCOUNT-DELETED" || $now > date("Y-m-d H:i", strtotime('+7 days',strtotime($h->Booking_end))) ) disabled @endif"
                        ...
                        <a class="btn btn-warning btn-sm @if($h->status == "DELETED" || $h->status == "ACCOUNT-DELETED" || $now > date("Y-m-d H:i", strtotime('+7 days',strtotime($h->Booking_end)))) disabled @endif"
                            href="{{ route('admin.bookings.show', $h->Booking_id) }}">Delete</a></div></td>
                                  </tr>
                          @endforeach
