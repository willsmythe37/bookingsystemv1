    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
                <h1>Delete Selected History</h1>
                    ...
                    @else
                    <h5>You searched for the word <strong>'{{ $search }}'</strong>.</h5>
                    @endif
                    @if($begin == null)
                    ...
                    <h5>@if($search == null)
                        ...
                        and you
                        @endif
                        searched from <strong>'{{ date("d-m-Y H:i", strtotime($begin)) }}'</strong>, until <strong>'{{ date("d-m-Y H:i", strtotime($end)) }}'</strong>.</h5>
                    <br>
                    @endif

                    <p>Submit the form if you are certain you wish to delete this area of booking history. </p>
                    <br>
                <form id="range" action="{{ route('admin.history.clearout')}}" method="POST">
                    {{ method_field('POST')}}
                    @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <input id="search" maxlength="50" type="text" placeholder="e.g. fred"
                                ...
                                value="{{ $search }}" autocomplete="search" hidden>
        ...
        <button type="submit" class="btn btn-warning btn-sm">Delete selected history</button><a href="{{ route('admin.history.index') }}"><button type="button" class="btn btn-secondary btn-sm">Back to History</button></a>
        </form><br><hr>
