...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-md-8 text-left">
            ...
            <form id="BookingForm" action="{{ route('admin.bookings.destroy', $booking) }}" method="post">
                {{ method_field('DELETE')}}
                <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input id="guitarheadamount" type="text" step="1"
                            class="addpadding form-control @error('guitarheadamount') is-invalid @enderror" name="guitarheadamount" readonly="true"
                    ...
                    <div class="col-md-2">
                        <input id="guitarcabamount" type="text" step="1"
                            class="addpadding form-control @error('guitarcabamount') is-invalid @enderror" name="guitarcabamount" readonly="true"
                    ...
                    <div class="col-md-2">
                        <input id="guitarcomboamount" type="text" step="1"
                            class="addpadding form-control @error('guitarcomboamount') is-invalid @enderror"
                            name="guitarcomboamount" readonly="true"
                ...
                <div class="form-group row">
                    <label
                        class="col-md-2 col-form-label text-md-right">{{ __('Bass Head') }}</label>

                    <div class="col-md-2">
                        <input id="bassheadamount" type="text" step="1"
                            class="addpadding form-control @error('bassheadamount') is-invalid @enderror" name="bassheadamount" readonly="true"
                    ...
                    <label
                        class="col-md-2 col-form-label text-md-right">{{ __('Bass Cab') }}</label>

                    <div class="col-md-2">
                        <input id="basscabamount" type="text" step="1"
                            class="addpadding form-control @error('basscabamount') is-invalid @enderror" name="basscabamount" readonly="true"
                    ...
                    <label
                        class="col-md-2 col-form-label text-md-right">{{ __('Bass Combos') }}</label>

                    <div class="col-md-2">
                        <input id="basscomboamount" type="text" step="1"
                            class="addpadding form-control @error('basscomboamount') is-invalid @enderror" name="basscomboamount"  readonly="true"
                ...
                <div class="form-group row">
                    <label
                        class="col-md-2 col-form-label text-md-right">{{ __('Drum Kit') }}</label>

                    <div class="col-md-2">
                        <input id="drumkitamount" type="text" step="1"
                            class="addpadding form-control @error('drumkitamount') is-invalid @enderror" name="drumkitamount"  readonly="true"
                    ...
                    <div class="col-md-2">
                        <input id="cymbalsamount" type="text" step="1"
                            class="addpadding form-control @error('cymbalsamount') is-invalid @enderror" name="cymbalsamount" readonly="true"
                ...
                <div class="form-group row">
                    <div class="col-md-12 offset-md-3">
                        <div class="form-check">
                            <input name="Payment_status" type="hidden" value="0" readonly="true">
                            <input class="form-check-input" type="checkbox" name="Payment_status" value="1" readonly="true"
                            autocomplete="Payment_status"
                            @if(old('Payment_status', $booking->Payment_status))
                            checked
                            @endif
                            disabled>

                            <label class="form-check-label">
                                Has the customer made a payment?
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <a href="{{ route('admin.history.index') }}"><button type="button" class="btn btn-secondary btn-sm">Back
                        to History</button></a>
                @csrf
            </form>
            <hr>
