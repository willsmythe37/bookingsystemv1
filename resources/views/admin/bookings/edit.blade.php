...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-md-8 text-left">
            ...
            <form id="BookingForm" action="{{ route('admin.bookings.update', $booking) }}" method="post">
                {{ method_field('PUT')}}
                <div class="row">
                ...
                <div class="input-group col-lg-6">
                    ...
                    <input type="text" value="{{ old('Booking_start_time') ? old('Booking_start_time') : date("H:i", strtotime($booking->Booking_start)) }}" step="1800" id="Booking_start_time" aria-label="Booking_start_time"
                ...
                <div class="input-group col-lg-6">
                    ...
                    <input type="text" value="{{ old('Booking_end_time') ? old('Booking_end_time') : date("H:i", strtotime($booking->Booking_end)) }}" step="1800" id="Booking_end_time" aria-label="Booking_end_time"
                        name="Booking_end_time" pattern="[0-9]{2}:[0-9]{2}" class="form-control @error('Booking_end_time') is-invalid @enderror"
                        required>
            ...
            <div class="form-group row">
                <label class="addpadding col-md-2 col-form-label text-md-right">{{ __('Guitar Head') }}</label>
            ...
            <div class="form-group row">
                <div class="col-md-12 offset-md-3">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="Payment_status" value="1"
                ...
                <a href="{{ route('admin.history.index') }}"><button type="button" class="btn btn-secondary btn-sm">Back to History</button></a>
                @csrf
            </form><hr>
